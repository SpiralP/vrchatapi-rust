...
) -> Result<Vec<crate::models::UserSubscription>, Error<GetCurrentSubscriptionsError>> {
...
) -> Result<crate::models::LicenseGroup, Error<GetLicenseGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn get_steam_transaction(
    configuration: &configuration::Configuration,
    transaction_id: &str,
) -> Result<crate::models::Transaction, Error<GetSteamTransactionError>> {
    let local_var_configuration = configuration;
...
pub async fn get_steam_transactions(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::Transaction>, Error<GetSteamTransactionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_subscriptions(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::Subscription>, Error<GetSubscriptionsError>> {
    let local_var_configuration = configuration;
