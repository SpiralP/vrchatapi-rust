...
pub async fn accept_friend_request(
    ...
    notification_id: &str,
) -> Result<crate::models::Success, Error<AcceptFriendRequestError>> {
...
pub async fn clear_notifications(
    configuration: &configuration::Configuration,
) -> Result<crate::models::Success, Error<ClearNotificationsError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_notification(
    configuration: &configuration::Configuration,
    notification_id: &str,
) -> Result<crate::models::Notification, Error<DeleteNotificationError>> {
    let local_var_configuration = configuration;
...
pub async fn get_notifications(
    ...
    n: Option<i32>,
    offset: Option<i32>,
) -> Result<Vec<crate::models::Notification>, Error<GetNotificationsError>> {
    let local_var_configuration = configuration;
...
pub async fn mark_notification_as_read(
    configuration: &configuration::Configuration,
    notification_id: &str,
) -> Result<crate::models::Notification, Error<MarkNotificationAsReadError>> {
    let local_var_configuration = configuration;
