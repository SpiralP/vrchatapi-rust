...
pub async fn add_favorite(
    ...
    add_favorite_request: Option<crate::models::AddFavoriteRequest>,
) -> Result<crate::models::Favorite, Error<AddFavoriteError>> {
...
pub async fn clear_favorite_group(
    ...
    user_id: &str,
) -> Result<crate::models::Success, Error<ClearFavoriteGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn get_favorite(
    configuration: &configuration::Configuration,
    favorite_id: &str,
) -> Result<crate::models::Favorite, Error<GetFavoriteError>> {
    let local_var_configuration = configuration;
...
pub async fn get_favorite_group(
    ...
    favorite_group_name: &str,
    user_id: &str,
) -> Result<crate::models::FavoriteGroup, Error<GetFavoriteGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn get_favorite_groups(
    ...
    offset: Option<i32>,
    owner_id: Option<&str>,
) -> Result<Vec<crate::models::FavoriteGroup>, Error<GetFavoriteGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_favorites(
    ...
    _type: Option<&str>,
    tag: Option<&str>,
) -> Result<Vec<crate::models::Favorite>, Error<GetFavoritesError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_favorite(
    configuration: &configuration::Configuration,
    favorite_id: &str,
) -> Result<crate::models::Success, Error<RemoveFavoriteError>> {
    let local_var_configuration = configuration;
...
pub async fn update_favorite_group(
    ...
    favorite_group_name: &str,
    user_id: &str,
    update_favorite_group_request: Option<crate::models::UpdateFavoriteGroupRequest>,
