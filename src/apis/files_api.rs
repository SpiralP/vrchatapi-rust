...
pub async fn create_file(
    ...
    create_file_request: Option<crate::models::CreateFileRequest>,
...
pub async fn create_file_version(
    configuration: &configuration::Configuration,
    file_id: &str,
    create_file_version_request: Option<crate::models::CreateFileVersionRequest>,
) -> Result<crate::models::File, Error<CreateFileVersionError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_file(
    configuration: &configuration::Configuration,
    file_id: &str,
) -> Result<crate::models::Success, Error<DeleteFileError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_file_version(
    ...
    file_id: &str,
    version_id: i32,
) -> Result<crate::models::File, Error<DeleteFileVersionError>> {
    let local_var_configuration = configuration;
...
pub async fn finish_file_data_upload(
    ...
    version_id: i32,
    file_type: &str,
    finish_file_data_upload_request: Option<crate::models::FinishFileDataUploadRequest>,
...
pub async fn get_file(
    configuration: &configuration::Configuration,
    file_id: &str,
) -> Result<crate::models::File, Error<GetFileError>> {
    let local_var_configuration = configuration;
...
pub async fn get_file_data_upload_status(
    ...
    version_id: i32,
    file_type: &str,
) -> Result<crate::models::FileVersionUploadStatus, Error<GetFileDataUploadStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn get_files(
    ...
    n: Option<i32>,
    offset: Option<i32>,
) -> Result<Vec<crate::models::File>, Error<GetFilesError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::FileUploadUrl, Error<StartFileDataUploadError>> {
    let local_var_configuration = configuration;
