...
pub async fn delete_friend_request(
    ...
    user_id: &str,
) -> Result<crate::models::Success, Error<DeleteFriendRequestError>> {
...
pub async fn friend(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<crate::models::Notification, Error<FriendError>> {
    let local_var_configuration = configuration;
...
pub async fn get_friend_status(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<crate::models::FriendStatus, Error<GetFriendStatusError>> {
    let local_var_configuration = configuration;
...
pub async fn get_friends(
    ...
    n: Option<i32>,
    offline: Option<bool>,
) -> Result<Vec<crate::models::LimitedUser>, Error<GetFriendsError>> {
    let local_var_configuration = configuration;
...
pub async fn unfriend(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<crate::models::Success, Error<UnfriendError>> {
    let local_var_configuration = configuration;
