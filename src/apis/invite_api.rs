...
pub async fn get_invite_message(
    ...
    message_type: &str,
    slot: i32,
) -> Result<crate::models::InviteMessage, Error<GetInviteMessageError>> {
    ...
    let local_var_uri_str = format!(
        ...
        messageType = crate::apis::urlencode(message_type),
        slot = slot
    );
...
pub async fn get_invite_messages(
    ...
    user_id: &str,
    message_type: &str,
) -> Result<Vec<crate::models::InviteMessage>, Error<GetInviteMessagesError>> {
    let local_var_configuration = configuration;
...
pub async fn invite_user(
    configuration: &configuration::Configuration,
    user_id: &str,
    invite_request: Option<crate::models::InviteRequest>,
) -> Result<crate::models::Notification, Error<InviteUserError>> {
    let local_var_configuration = configuration;
...
pub async fn request_invite(
    configuration: &configuration::Configuration,
    user_id: &str,
    request_invite_request: Option<crate::models::RequestInviteRequest>,
) -> Result<crate::models::Notification, Error<RequestInviteError>> {
    let local_var_configuration = configuration;
...
pub async fn reset_invite_message(
    ...
    message_type: &str,
    slot: i32,
) -> Result<Vec<crate::models::InviteMessage>, Error<ResetInviteMessageError>> {
    let local_var_configuration = configuration;
...
pub async fn respond_invite(
    configuration: &configuration::Configuration,
    notification_id: &str,
    invite_response: Option<crate::models::InviteResponse>,
...
pub async fn update_invite_message(
    ...
    message_type: &str,
    slot: i32,
    update_invite_message_request: Option<crate::models::UpdateInviteMessageRequest>,
) -> Result<Vec<crate::models::InviteMessage>, Error<UpdateInviteMessageError>> {
    let local_var_configuration = configuration;
