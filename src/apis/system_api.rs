...
) -> Result<crate::models::ApiConfig, Error<GetConfigError>> {
...
pub async fn get_health(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ApiHealth, Error<GetHealthError>> {
    let local_var_configuration = configuration;
...
pub async fn get_info_push(
    ...
    require: Option<&str>,
    include: Option<&str>,
) -> Result<Vec<crate::models::InfoPush>, Error<GetInfoPushError>> {
    let local_var_configuration = configuration;
