...
) -> Result<crate::models::UserExists, Error<CheckUserExistsError>> {
...
pub async fn delete_user(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<crate::models::CurrentUser, Error<DeleteUserError>> {
    let local_var_configuration = configuration;
...
pub async fn logout(
    configuration: &configuration::Configuration,
) -> Result<crate::models::Success, Error<LogoutError>> {
    let local_var_configuration = configuration;
...
pub async fn verify2_fa(
    configuration: &configuration::Configuration,
    two_factor_auth_code: Option<crate::models::TwoFactorAuthCode>,
) -> Result<crate::models::Verify2FaResult, Error<Verify2FaError>> {
    let local_var_configuration = configuration;
...
pub async fn verify_auth_token(
    configuration: &configuration::Configuration,
) -> Result<crate::models::VerifyAuthTokenResult, Error<VerifyAuthTokenError>> {
    let local_var_configuration = configuration;
...
pub async fn verify_recovery_code(
    configuration: &configuration::Configuration,
    two_factor_auth_code: Option<crate::models::TwoFactorAuthCode>,
) -> Result<crate::models::Verify2FaResult, Error<VerifyRecoveryCodeError>> {
    let local_var_configuration = configuration;
