...
) -> Result<crate::models::Success, Error<ClearAllPlayerModerationsError>> {
...
) -> Result<crate::models::Success, Error<DeletePlayerModerationError>> {
    let local_var_configuration = configuration;
...
pub async fn get_player_moderation(
    configuration: &configuration::Configuration,
    player_moderation_id: &str,
) -> Result<crate::models::PlayerModeration, Error<GetPlayerModerationError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<crate::models::PlayerModeration>, Error<GetPlayerModerationsError>> {
    let local_var_configuration = configuration;
...
pub async fn moderate_user(
    configuration: &configuration::Configuration,
    moderate_user_request: Option<crate::models::ModerateUserRequest>,
) -> Result<crate::models::PlayerModeration, Error<ModerateUserError>> {
    let local_var_configuration = configuration;
...
pub async fn unmoderate_user(
    configuration: &configuration::Configuration,
    moderate_user_request: Option<crate::models::ModerateUserRequest>,
) -> Result<crate::models::Success, Error<UnmoderateUserError>> {
    let local_var_configuration = configuration;
