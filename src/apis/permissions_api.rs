...
pub async fn get_assigned_permissions(
...
) -> Result<Vec<crate::models::Permission>, Error<GetAssignedPermissionsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAssignedPermissionsError> =
...
pub async fn get_permission(
    configuration: &configuration::Configuration,
    permission_id: &str,
) -> Result<crate::models::Permission, Error<GetPermissionError>> {
    let local_var_configuration = configuration;
